...
bool KeyFrame::findConnection(KeyFrame* old_kf) {
    ...
    TicToc t_match;
		...
		if (DEBUG_IMAGE)    
	    {
	        ...
	        ostringstream path;
	        path << "/home/jeffery/Documents/ROS/VINS/data/raw_data/loop_image/"
	                << index << "-"
    ...
    // printf("search by des finish\n");
		...
		if (DEBUG_IMAGE)
	    {
	        ...
	        cv::imwrite( path.str().c_str(), loop_match_img);
	        /*
	        path1 <<  "/home/jeffery/Documents/ROS/VINS/data/raw_data/loop_image/"
	                << index << "-"
	                << old_kf->index << "-" << "1descriptor_match_1.jpg";
	        cv::imwrite( path1.str().c_str(), image);
	        path2 <<  "/home/jeffery/Documents/ROS/VINS/data/raw_data/loop_image/"
	                << index << "-"
